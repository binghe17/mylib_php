...
/* USE
	...
	$smtpusermail = "aaaa@qq.com";//SMTP服务器的用户邮箱
	$smtpemailto = "aaaa@qq.com";//发送给谁
	$smtpuser = "aaaa";//SMTP服务器的用户帐号
	$smtppass = "";//SMTP服务器的用户密码
	$mailsubject = "aaaa.com测试邮件系统";//邮件主题
	$mailbody = "<h1> 这是一个测试程序 aaaa.com </h1>";//邮件内容
